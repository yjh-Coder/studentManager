<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="学籍成绩管理系统.user.Student" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src='<%=ResolveUrl("../Scripts/layui/layui.js")%>'></script>
                ...
                <div class="layui-side-scroll">
                    <ul class="layui-nav layui-nav-tree" lay-filter="test">
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                <dd>
                                    <button class="layui-btn site-demo-active layui-bg-black" data-type="tabAdd1" style="width: 100%"><i class="iconfont icon-xuanke">选课</i></button></dd>
                                <dd>
                                    <button class="layui-btn site-demo-active layui-bg-black" data-type="tabAdd2" style="width: 100%"><i class="iconfont icon-tui">退课</i></button></dd>
                                <dd>
                                    <button class="layui-btn site-demo-active layui-bg-black" data-type="tabAdd3" style="width: 100%"><i class="iconfont icon-chakan">查看已选课程</i></button></dd>
                                <dd>
                                    <button class="layui-btn site-demo-active layui-bg-black" data-type="tabAdd4" style="width: 100%"><i class="iconfont icon-xiugai07">修改个人信息</i></button></dd>
                            </dl>
                        </li>
                    </ul>
                </div>
                ...
                <div class="layui-tab" lay-filter="demo" lay-allowclose="true">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <img src="../../Login/images/动漫2.jpg" style="width: 100%; height: 530px;" />
                        </div>
