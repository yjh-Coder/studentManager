<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacher_manage.aspx.cs" Inherits="学籍成绩管理系统.manager.teacher_manage" %>
                            ...
                            layui.use('table', function () {
                                ...
                                table.render({
                                    ...
                                    , cols: [[
                                        ...
                                        { field: '教师编号', width: 200, title: '教师编号', sort: true, totalRowText: '合计' },
                                        { field: '教师名称', width: 200, title: '教师名称', sort: true },
                                        { field: '学院', width: 200, title: '学院', sort: true },
                                        { field: '性别', width: 200, title: '性别', sort: true },
