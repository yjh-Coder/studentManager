<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_student.aspx.cs" Inherits="学籍成绩管理系统.manager.edit_student" %>
    ...
    <form id="form1" runat="server" class="layui-form">
          <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <asp:TextBox ID="tb_sno" runat="server" name="tb_sno" lay-verify="required" autocomplete="off" placeholder="请输入学号" class="layui-input"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <asp:TextBox ID="tb_sname" runat="server" name="tb_sname" lay-verify="required" autocomplete="off" placeholder="请输入学生姓名" class="layui-input"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <asp:TextBox ID="tb_password" runat="server" name="tb_password" lay-verify="required" placeholder="请输入学生密码" autocomplete="off" class="layui-input"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block" style="width: 300px;">
                    <asp:TextBox ID="tb_identication" runat="server" class="layui-input" name="tb_identication"  autocomplete="off"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block" style="width: 300px;">
                    <asp:TextBox ID="tb_enrollment_year" runat="server" class="layui-input" name="tb_enrollment_year" lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off"></asp:TextBox>
                </div>
            </div>
        </div>
