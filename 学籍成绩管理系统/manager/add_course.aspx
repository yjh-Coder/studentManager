<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_course.aspx.cs" Inherits="学籍成绩管理系统.manager.add_course" %>
    ...
    <form id="form1" class="layui-form" runat="server">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <asp:TextBox ID="tb_cid" runat="server" name="cid" lay-verify="required" autocomplete="off" placeholder="请输入课程编号" class="layui-input"></asp:TextBox>
            </div>
        </div>
