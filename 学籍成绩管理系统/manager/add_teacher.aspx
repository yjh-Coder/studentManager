<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_teacher.aspx.cs" Inherits="学籍成绩管理系统.manager.add_teacher" %>
    ...
    <form id="form1" runat="server" class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <asp:TextBox ID="tb_tid" runat="server" name="tid" lay-verify="required" autocomplete="off" placeholder="请输入老师编号" class="layui-input"></asp:TextBox>
            </div>
        </div>
